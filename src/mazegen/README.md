...
# ---- MAZE GENERATOR ----
  ...
  ### 2. Maze generation<br><br>
  To generate a maze, you need to use the method generate_maze() (no parameters needed).<br>
  The maze generated will have a centered "42" pattern if it is big enough (10x10 minimum) and if the entry/exit points are not inside it.<br><br>
